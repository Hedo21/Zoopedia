                            ...
                            <section id="tambah_penjaga">
                                <div id="tambah_penjaga">
                                    <div class="col-sm-12">
                                        <div class="x_panel">
                                            <div class="x_title">
                                                <h2 style="font-weight: bold;">Tambah Penjaga</h2>
                                            ...
                                            <div class="x_content">
                                                <br />
                                                <form class="form-horizontal form-label-left" action="aksi_tambahpenjaga.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-3 col-sm-3 ">Nama Penajaga</label>
                                                        <div class="col-md-9 col-sm-9 ">
                                                            <input type="text" class="form-control" placeholder="" id="nama_penjaga" name="nama_penjaga" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-3 col-sm-3 ">Alamat Penjaga</label>
                                                        <div class="col-md-9 col-sm-9 ">
                                                            <input type="text" class="form-control" placeholder="" id="alamat_penjaga" name="alamat_penjaga" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-3 col-sm-3 ">No. Telepon</label>
                                                        <div class="col-md-9 col-sm-9 ">
                                                            <input type="number" min="1" class="form-control" placeholder="" id="no_telepon_penjaga" name="no_telepon_penjaga" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row ">
                                                        <label class="control-label col-md-3 col-sm-3 ">Email Penjaga</label>
                                                        <div class="col-md-9 col-sm-9 ">
                                                            <input type="text" class="form-control" placeholder="" id="email_penjaga" name="email_penjaga" required>
                                                        </div>
                                                    </div>
                                                    <button type="submit" class="btn btn-success" style="float: right;">Submit</button>
                                                    <button type="reset" class="btn btn-outline-info" style="float: right;">Reset</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
