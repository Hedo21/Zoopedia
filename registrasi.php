                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                <div class="form-block">
                                    <div class="mb-4">
                                        <h3>Buat Akun <strong>Zoopedia</strong></h3>
                                        <p class="mb-4">Silahkan isi kolom dibawah </p>
                                    </div>
                                    <form action="#" method="post">
                                        ...
                                        <div class="d-block text-center my-4 text-muted">
                                            <select name="level" id="level" hidden>
                                                <option value="pelanggan">Pelanggan</option>
                                            </select>
                                        </div>
                                        <input type="submit" value="Buat" class="btn btn-pill text-white btn-block btn-primary">
                                        <a href="index.php" class="d-block text-center my-4 text-muted">Kembali</a>
                                    </form>
                                </div>
                            </div>
                        </div>
